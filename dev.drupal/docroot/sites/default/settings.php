...
elseif (!empty($_ENV['AH_SITE_GROUP'])) {
  ...
  switch (DRUPAL_ROOT) {
    case '__DEV_DOCROOT_PATH__':
      ...
      $settings['memcache']['key_prefix'] = 'dev_drupal_dev';
      $settings['varnish_purge_zeroconfig_hosts'] = ['dev.drupal.dev'];
      $settings['varnish_purge_zeroconfig_port'] = 80;
      $settings['trusted_host_patterns'] = ['^dev\.drupal\.dev$'];
    ...
    case '__STG_DOCROOT_PATH__':
      ...
      $settings['memcache']['servers'] = ['localhost:11211' => 'default'];
      $settings['memcache']['key_prefix'] = 'stg_drupal_dev';
      $settings['varnish_purge_zeroconfig_hosts'] = ['stg.drupal.dev'];
      $settings['varnish_purge_zeroconfig_port'] = 80;
      $settings['trusted_host_patterns'] = ['^stg\.drupal\.dev$'];
      $config['system.logging']['error_level'] = 'verbose';
      break;
    ...
    case '__PROD_DOCROOT_PATH__':
      ...
      $settings['memcache']['servers'] = ['localhost:11211' => 'default'];
      $settings['memcache']['key_prefix'] = 'www_drupal_dev';
      $settings['varnish_purge_zeroconfig_hosts'] = ['www.drupal.dev'];
      $settings['varnish_purge_zeroconfig_port'] = 80;
      $settings['trusted_host_patterns'] = ['^(www\.)?drupal\.dev$'];
      break;
  }
